...
/**
 * binary_tree_insert_right - will inserts a node as the right child of another node.
 *
 * @parent: A pointer to the node to the node the right child will be inserted in.
